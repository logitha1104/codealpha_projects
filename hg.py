...
class Hangman:
    ...
    def create_widgets(self):
        self.instruction_label = tk.Label(self.master, text="Welcome to Hangman Game!",font=('Arial', 50),fg="LightGoldenrod1",bg="gray1")
        self.instruction_label.place(x=350,y=100)

        self.guess_label = tk.Label(self.master, text="Enter your Guess:",font=('Arial', 30),fg="linen",bg="gray1")
        self.guess_label.place(x=350,y=250)

        self.guess_entry = tk.Entry(self.master,font=('Arial', 30),fg="linen",bg="gray1")
        self.guess_entry.place(x=700,y=250)

        self.submit_button = tk.Button(self.master, text="Submit", command=self.check_guess,font=('Arial', 30),fg="gray2",bg="gray80")
